...
class PictureViewerMobileView extends PopupViewImpl implements PictureViewerPresenter.MyView {
   
	interface Binder extends UiBinder<Widget, PictureViewerMobileView> {
    }
    ...
    @Inject
    PictureViewerMobileView(EventBus eventBus, Binder uiBinder) {
        super(eventBus);
    ...
    static class Constants {
    	public static int getPaddingTopBottom() { return 0; }// If update this value, also update popup.padding in UiBinder
    	public static int getPaddingRightLeft() { return 0; }// If update this value, also update popup.padding in UiBinder
	...
	public int getMaxWidth() {
		return Window.getClientWidth() - Constants.getPaddingTopBottom() * 2;
	}
